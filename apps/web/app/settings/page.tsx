...
export default function SettingsPage() {
    ...
    const hasChanges = useMemo(() => {
        ...
        if (apiKeyInput.trim() || tavilyApiKeyInput.trim()) return true;
        ...
        return false;
    }, [draft, settings, apiKeyInput, tavilyApiKeyInput]);
    ...
    return (
        <div className="min-h-screen py-8">
            <Container>
                ...
                {/* ── Page Header ──────────────────────────────── */}
                <div className="mb-8">
                    <p className="text-sm text-[var(--text-muted)]">Pages / Settings</p>
                ...
                <section className="mb-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Configure external search, screenshot storage, file-system safety boundaries, and application discovery roots.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                                    ...
                                    <div id="tools-files" className="scroll-mt-28 rounded-[var(--radius-lg)] border border-[var(--border)] overflow-hidden">
                                        <div className="flex items-center gap-3 px-5 py-4 bg-[var(--surface)]">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <p className="text-xs text-[var(--text-muted)]">
                                                    Configure the default starting folder plus the allowed read and write boundaries for file tools such as <code className="text-[var(--accent)] bg-[var(--surface-elevated)] px-1 rounded">find_files</code>, <code className="text-[var(--accent)] bg-[var(--surface-elevated)] px-1 rounded">read_file</code>, <code className="text-[var(--accent)] bg-[var(--surface-elevated)] px-1 rounded">list_directory</code>, and <code className="text-[var(--accent)] bg-[var(--surface-elevated)] px-1 rounded">write_file</code>.
                                                </p>
                                            </div>
                                        ...
                                        <div className="px-5 py-4 border-t border-[var(--border)] bg-[var(--bg)] space-y-5">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                                                <div className="space-y-2">
                                                    ...
                                                    />
                                                    <FieldHint>
                                                        Used as the default starting folder when a file tool needs a base location and no specific root is provided.
                                                    </FieldHint>
                                                </div>
            ...
            {/* ── Floating Save Bar ────────────────────────────── */}
            {hasChanges && (
                <div className="fixed bottom-6 left-64 right-0 px-6 pointer-events-none z-50">
